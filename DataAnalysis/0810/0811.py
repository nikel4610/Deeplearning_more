...
seoul['seoul_confirmed_ratio'] = seoul['서울시 확진자'] / seoul['전국 확진']
seoul['seoul_death_ratio'] = seoul['서울시 사망'] / seoul['전국 사망']
seoul['seoul_recovered_ratio'] = seoul['서울시 퇴원'] / seoul['전국 퇴원']

seoul = seoul[['서울시 기준일', 'seoul_confirmed_ratio', 'seoul_death_ratio', 'seoul_recovered_ratio']]

seoul.columns = ['date', 'seoul_confirmed_ratio', 'seoul_death_ratio', 'seoul_recovered_ratio']
seoul['seoul_recovered_ratio'].replace('', 0, inplace = True)

seoul.to_csv('./COVID-19-master/seoul_ratio.csv')